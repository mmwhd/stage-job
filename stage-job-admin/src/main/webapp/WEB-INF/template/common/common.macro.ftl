...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>STAGE</b></span>
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>STAGE-JOB</b> 1.9.0（快照版本）
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="http://www.hayden.com/" target="_blank" >hayden</a>
				&nbsp;
                <a href="https://github.com/mmwhd/stage-job" target="_blank" >github</a>
