...
import com.stage.job.admin.core.util.CookieUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
    ...
    static {
        String username = PropertiesUtil.getString("stage.job.login.username");
        String password = PropertiesUtil.getString("stage.job.login.password");
